    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-white/20">
      ...
      <section className="relative flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        ...
        <h1 className="mx-auto max-w-3xl text-balance font-serif text-5xl leading-tight tracking-tight sm:text-5xl lg:text-7xl z-10">
          <GrayTitle>Agex</GrayTitle>
          <br />
          <SlateTitle>One Prompt, Endless Possibilities...</SlateTitle>
        </h1>
        <p className="mx-auto mt-6 max-w-xl text-balance text-base leading-relaxed text-zinc-500 z-10">
            Describe it. Watch it come alive.
          AI writes the code, installs everything, and ships it—right in your browser. 
          </p>
          {/* prompt box */}
          ...
          >
            <textarea
              ...
              rows={1}
              className="w-full resize-none bg-transparent px-5 pb-5 pt-5 text-sm placeholder:text-white/20 focus:outline-none sm:text-base"
